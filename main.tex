...
\lstdefinelanguage{SPARQL}{
  ...
  morekeywords={rdf,rdfs,owl,xsd,purl,wdt,wd,ps,pq,p,bd,wikibase},
  % -------------------------- keywords
  classoffset=2,
...
\lstdefinelanguage{CustomXML}{
  ...
  % --------------------------
  morestring=[b]",
  moredelim=[s][\bfseries\color{MidnightBlue}]{<}{\ },
  moredelim=[s][\bfseries\color{MidnightBlue}]{</}{>},
  moredelim=[l][\bfseries\color{MidnightBlue}]{/>},
  moredelim=[l][\bfseries\color{MidnightBlue}]{>},
  morecomment=[s]{<?}{?>},
  morecomment=[s]{<!--}{-->},
