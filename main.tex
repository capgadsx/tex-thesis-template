...
\newcommand{\dedicatoria}{Considerando lo importancia de este trabajo para los
alumnos, este apartado es para que el autor entregue palabras personales para
dedicar este documento. La extensión puede ser de máximo una hoja y se deben
mantener este formato, tipo y tamaño de letra.
\hfill\vfill
\textit{nanos gigantum humeris insidentes}.}
...
Semántica; Autocompletado.} \newcommand{\palabrasclaveingles}{\textit{SPARQL};
\textit{RDF}; \textit{Semantic Web}; \textit{Autocompletion}.}
% @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@>
