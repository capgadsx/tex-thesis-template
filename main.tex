...
SPARQL; RDF; Web Semántica; Autocompletado.
}
\newcommand{\palabrasclaveingles}{
\textit{SPARQL}; \textit{RDF}; \textit{Semantic Web}; \textit{Autocompletion}.
}
% @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@>
...
\bibliographystyle{apalike} % FIXME: apalike-es throws error using 'others' in autors
